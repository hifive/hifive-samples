(function() {
  ...
  var controller = {
    ...
    '.gridHeaderRowsBox .gridCell h5trackmove': function(context) {
      ...
      var selector = '[data-h5-dyn-grid-column=' + this._selectedHeadderRowIdx + '] .grid-cell-frame';
    ...
    filter: function(condition) {
      function filterFunction(data) {
        ...
        if (condition.applicantMonth && data.applicationDate.slice(0, 7) != condition.applicantMonth) {
          return false;
        }
        return true;
      }
